...
CACHES = {
    'default': {
        ...
        'LOCATION': '{{ openstack_host_cache.data.Value }}:{{ openstack_memcached_port.data.Value }}',
    },
}
...
OPENSTACK_HOST = "{{ openstack_host_api.data.Value }}:{{ openstack_endpoint_keystone_port.data.Value }}"
OPENSTACK_KEYSTONE_URL = "{{ openstack_endpoint_schema.data.Value }}://{{ openstack_host_api.data.Value }}:{{ openstack_endpoint_keystone_port.data.Value }}/v3"
